...
*/
    ...
    if( trial.attentionCheck ){
      questions = questions.concat(['Have you ever used the internet? Answer five for all three scales on the right.']);
    }
...
*/
    ...
    'For the questions that you answer YES to, we are also interested in:'+
    ...
    'and how much you believe that it is true.<br>' +
