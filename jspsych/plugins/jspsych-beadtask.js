...
jsPsych.plugins['beadtask'] = (function(){
  ...
  plugin.trial = function(display_element, trial){
    ...
    html += '<div id="estimateContainer" class="container"></div>';
    html += '<div id="mainSketchContainer" class="container" style="height:400px;border:1px solid black;"></div>';
    ...
    if( trial.graded ) {
      $('#estimateContainer').css('height', '105px');
    }
